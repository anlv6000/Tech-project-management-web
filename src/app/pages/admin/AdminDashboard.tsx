...
export default function AdminDashboard() {
  const { users, projects, tasks, getRecentAuditLogs } = useData();
  ...
  const projectsByMethodology = [
    {
      name: "Agile",
      count: projects.filter((p) => p.methodology === "agile").length,
    },
    {
      name: "Kanban",
      count: projects.filter((p) => p.methodology === "kanban").length,
    },
    {
      name: "Waterfall",
      count: projects.filter((p) => p.methodology === "waterfall").length,
    },
  ];
